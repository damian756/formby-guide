...
const CATEGORIES: GalleryCategory[] = [
  {
    ...
    images: [
      ...
      { src: "/ainsdale-beach-dunes-sea-view.webp",    alt: "Ainsdale Beach — dune grass and Irish Sea",                 caption: "Ainsdale beach looking west — dune grass, wide sand, Irish Sea" },
      { src: "/ainsdale-dune-path-marram-grass.webp",  alt: "Dune path through marram grass at Ainsdale",               caption: "Marram grass path through the Ainsdale dunes" },
      { src: "/ainsdale-dunes-pinewoods-panorama.webp",alt: "Panoramic view of Ainsdale dunes and pinewoods",           caption: "Ainsdale dunes and pinewoods — the transition zone between beach and woodland" },
      { src: "/yellow-waymarker-ainsdale-dunes.webp",  alt: "Yellow waymarker post in Ainsdale sand dunes",             caption: "Waymarker post in the Ainsdale dunes — follow the markers" },
    ],
  },
  {
    id: "pinewoods",
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/england-coast-path-sign-ainsdale.webp", alt: "England Coast Path sign at Ainsdale Beach",                caption: "England Coast Path — runs the length of the Sefton Coast" },
    ],
  },
  {
    id: "beachcombing",
    label: "Beachcombing",
    images: [
      { src: "/mermaids-purse-held-hand-ainsdale.webp", alt: "Mermaid's purse — catshark egg case — held on Ainsdale Beach", caption: "Mermaid's purse — the empty egg case of a small-spotted catshark" },
      { src: "/barrel-jellyfish-dog-ainsdale-beach.webp", alt: "Barrel jellyfish on Ainsdale Beach with a dog investigating", caption: "Barrel jellyfish — one of the largest species found on the Sefton Coast" },
      { src: "/compass-jellyfish-closeup-ainsdale.webp", alt: "Compass jellyfish close-up on Ainsdale Beach", caption: "Compass jellyfish — named for the brown markings radiating from the centre" },
      { src: "/whelk-egg-mass-ainsdale-beach.webp", alt: "Whelk egg mass on the Ainsdale tideline", caption: "Whelk egg mass — looks like bubble wrap, feels like it too" },
      { src: "/razor-clam-ainsdale-beach.webp", alt: "Razor clam shell on Ainsdale Beach", caption: "Razor clam — the living animal burrows vertically in wet sand" },
      { src: "/flask-driftwood-shells-ainsdale.webp", alt: "Flask, driftwood and shells arranged on Ainsdale Beach", caption: "A winter morning's worth of beachcombing on Ainsdale" },
      { src: "/heart-shadow-driftwood-ainsdale.webp", alt: "Heart-shaped shadow cast by driftwood on Ainsdale Beach sand", caption: "Driftwood casting a heart shadow on the wet sand at Ainsdale" },
      { src: "/old-boat-ainsdale-dunes.webp", alt: "Old boat wreck in the Ainsdale sand dunes", caption: "Old boat buried in the Ainsdale dunes — the coast reclaims everything eventually" },
    ],
  },
  {
    id: "wildlife",
