    ...
    <div className="min-h-screen bg-[#F7F9F6]">
      ...
      <div className="container mx-auto px-4 py-12 max-w-3xl">
        <div className="bg-white rounded-2xl border border-gray-100 p-8 md:p-10 space-y-10">
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-[#1C3220] mb-4">1. Acceptance of terms</h2>
            <p className="text-gray-600 text-sm leading-relaxed">
              By accessing or using FormbyGuide.co.uk (the &ldquo;Site&rdquo;), you agree to be bound by these Terms &amp; Conditions. If you do not agree, please do not use the Site. If you are using the Site on behalf of a business, you confirm that you have authority to bind that business to these terms.
            </p>
          </section>

          <section>
            <h2 className="font-display text-xl font-bold text-[#1C3220] mb-4">2. About the Site</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-[#1C3220] mb-4">3. Use of the Site</h2>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={item} className="flex gap-3 text-sm text-gray-600">
                  <span className="text-[#C9A96E] flex-none">→</span>
                  {item}
                </li>
              ))}
            </ul>
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-[#1C3220] mb-4">4. Accuracy of information</h2>
            <p className="text-gray-600 text-sm leading-relaxed mb-3">
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-[#1C3220] mb-4">5. Business listing terms</h2>
            <div className="space-y-6">
              <div>
                <h3 className="font-semibold text-[#1C3220] text-sm mb-2">5.1 Free listings</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
              ...
              <div>
                <h3 className="font-semibold text-[#1C3220] text-sm mb-2">5.2 Paid subscriptions</h3>
                <ul className="space-y-2">
                  {[
                    ...
                    <li key={item} className="flex gap-3 text-sm text-gray-600">
                      <span className="text-[#C9A96E] flex-none mt-0.5">•</span>
                      {item}
                    </li>
                  ))}
                </ul>
              ...
              <div>
                <h3 className="font-semibold text-[#1C3220] text-sm mb-2">5.3 Your listing content</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
              ...
              <div>
                <h3 className="font-semibold text-[#1C3220] text-sm mb-2">5.4 Removal of listings</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  We reserve the right to remove or suspend any listing, at any time and without notice, that we reasonably believe: contains false or misleading information; breaches these terms; is associated with unlawful activity; or is harmful to the reputation of FormbyGuide.co.uk or other listed businesses.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-[#1C3220] mb-4">6. Intellectual property</h2>
            <p className="text-gray-600 text-sm leading-relaxed mb-3">
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-[#1C3220] mb-4">7. External links</h2>
            <p className="text-gray-600 text-sm leading-relaxed">
              This Site contains links to third-party websites, including business websites and the National Trust. We have no control over the content or practices of those sites and accept no responsibility for them. Links are provided for convenience only and do not constitute endorsement.
            </p>
          </section>

          <section>
            <h2 className="font-display text-xl font-bold text-[#1C3220] mb-4">8. Limitation of liability</h2>
            <p className="text-gray-600 text-sm leading-relaxed mb-3">
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-[#1C3220] mb-4">9. Governing law</h2>
            <p className="text-gray-600 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-[#1C3220] mb-4">10. Changes to these terms</h2>
            <p className="text-gray-600 text-sm leading-relaxed">
        ...
        <div className="mt-8 text-center text-sm text-gray-400">
          ...
          {" "}·{" "}
          <Link href="/privacy" className="text-[#2E6B3E] hover:underline">Privacy Policy</Link>
        </div>
      </div>
    </div>
  );
