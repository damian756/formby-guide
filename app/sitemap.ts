...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/the-open-2026`,                    lastModified: D.today, priority: 0.7, changeFrequency: "monthly" },
    { url: `${BASE_URL}/the-open-2026/accommodation`,     lastModified: D.today, priority: 0.6, changeFrequency: "monthly" },
    { url: `${BASE_URL}/the-open-2026/restaurants`,       lastModified: D.today, priority: 0.6, changeFrequency: "monthly" },
