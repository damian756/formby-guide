...
const AREAS = ["Freshfield", "Hightown", "Crosby", "Ainsdale", "Birkdale"];
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#F7F9F6]">
        ...
        {/* ── Hero ───────────────────────────────────────────────────── */}
        <div className="bg-[#1C3220] text-white">
          <div className="container mx-auto px-4 max-w-6xl py-12 md:py-16">
            <nav className="flex items-center gap-1.5 text-white/40 text-xs mb-6">
              ...
              <Link href="/collections" className="hover:text-white/70 transition-colors">
                Collections
              </Link>
              <ChevronRight className="w-3 h-3" />
            ...
            <div className="mt-6 flex items-center gap-3 text-sm text-white/50">
              <span className="font-semibold text-[#C9A96E] text-2xl">{count}</span>
        ...
        <div className="container mx-auto px-4 max-w-6xl py-10">
          ...
          {count === 0 ? (
            <div className="text-center py-20">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 mt-6 text-[#2E6B3E] font-semibold hover:underline"
              >
          ...
          {count > 0 && (
            <div className="mt-12 text-center">
              <p className="text-gray-500 text-sm mb-3">
                Want to see everything in{" "}
                {collection.categorySlugs.length > 1 ? "these categories" : "this category"}?
              </p>
          ...
          <div className="mt-14 bg-[#1C3220] rounded-2xl p-8 text-center">
            ...
            <p className="text-white/60 text-sm mb-5 max-w-sm mx-auto">
              List your business and get featured in relevant collections across FormbyGuide.
            </p>
            <Link
              href="/claim-listing"
...
function BusinessCard({ business: b }: { business: CollectionBusiness }) {
  ...
  const areaLabel = area === "Formby" ? "Formby" : `${area}, Formby`;
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-44 bg-gradient-to-br from-[#1C3220] to-[#2E6B3E] flex-none overflow-hidden">
        {b.photoUrl ? (
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="absolute top-3 right-3 w-20 h-20 bg-[#C9A96E]/10 rounded-full blur-2xl" />
      ...
      <div className="p-4 flex flex-col flex-1 gap-2">
        <h2 className="font-display font-bold text-[#1C3220] text-base leading-snug group-hover:text-[#2E6B3E] transition-colors line-clamp-2">
          {b.name}
        </h2>
