            ...
            return (
              <Link
                ...
                className={`group flex flex-col bg-white rounded-2xl overflow-hidden border transition-all hover:-translate-y-0.5 ${
                  isFeatured
                    ? "border-[#C9A96E]/40 ring-1 ring-[#C9A96E]/15 shadow-md hover:shadow-lg"
              ...
              >
                ...
                <div className="p-4 flex flex-col flex-1">
                  <h2 className="font-display font-bold text-[#1C3220] text-base leading-snug group-hover:text-[#2E6B3E] transition-colors mb-1 line-clamp-2">
                    {b.name}
                  </h2>
