...
export const BLOG_POSTS: BlogPost[] = [
  ...
  {
    slug: "formby-open-week-2026",
    title: "Formby During Open Week: The Quieter Alternative to Southport",
    excerpt: "Southport is busy this week. Formby, eight miles south, is not. If you want the beach, the pinewoods and the red squirrels without the Open week chaos, here is why Formby is the better call.",
    author: "Clare",
    date: "July 14, 2026",
    readTime: "4 min read",
    categorySlug: "seasonal",
    gradient: "linear-gradient(135deg, #1A5C3A 0%, #2E8A6E 100%)",
    image: "/blog-formby-open-week.webp",
    metaTitle: "Formby During Open Week 2026: The Quieter Alternative",
    metaDescription: "Southport is busy during The Open 2026. Formby, eight miles south on the Sefton Coast, is the quieter option. Beach, pinewoods, red squirrels and good restaurants without the crowds.",
  },
  {
    slug: "formby-cycling-routes",
    title: "Cycling in Formby: Routes, Paths and What to Know",
    excerpt: "Formby has more cycling infrastructure than most visitors realise. The coastal path, the NT access tracks, and the quiet village lanes. Here is what is actually rideable and what to expect.",
    author: "Clare",
    date: "July 14, 2026",
    readTime: "5 min read",
    categorySlug: "walks",
    gradient: "linear-gradient(135deg, #1C4A5A 0%, #2E7A9A 100%)",
    image: "/blog-formby-cycling.webp",
    metaTitle: "Cycling in Formby: Routes and Practical Guide",
    metaDescription: "Cycling routes in Formby: the coastal path, NT access tracks and village lanes. What is rideable, where to park a bike, and the honest assessment of what works for families.",
  },
  {
    slug: "formby-rainy-day-guide",
    title: "What to Do in Formby When It Rains",
    excerpt: "British summer, British weather. If your Formby day turns wet, here is an honest guide to what actually works: where to eat, where to shelter, and how to salvage a rainy day without driving to a retail park.",
    author: "Clare",
    date: "July 1, 2026",
    readTime: "5 min read",
    categorySlug: "seasonal",
    gradient: "linear-gradient(135deg, #1C4A5A 0%, #2E5A7A 100%)",
    image: "/blog-formby-rainy-day.webp",
    metaTitle: "What to Do in Formby When It Rains: The Honest Guide",
    metaDescription: "Rainy day in Formby? Here is what Clare actually recommends: where to eat, where to shelter, and what is worth doing even in the wet. No retail parks.",
  },
  {
    slug: "formby-national-trust-first-visit",
    title: "Your First Visit to the National Trust at Formby: What to Expect",
    excerpt: "Everyone knows Formby NT exists. Fewer people know how it actually works when you get there: where to park, what to book, which trail to do first, and what the squirrel sightings are like in July.",
    author: "Clare",
    date: "July 1, 2026",
    readTime: "6 min read",
    categorySlug: "wildlife",
    gradient: "linear-gradient(135deg, #1A5C3A 0%, #2E8A6E 100%)",
    image: "/blog-formby-nt-first-visit.webp",
    metaTitle: "First Visit to National Trust Formby: Everything You Need to Know",
    metaDescription: "Planning your first visit to the National Trust at Formby? Clare covers parking, booking, which trails to walk, red squirrel sighting odds in July, and what to bring.",
  },
  {
